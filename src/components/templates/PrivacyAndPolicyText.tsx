      ...
      <Box>
        <Stack spacing="40px">
          ...
          <Text fontSize="16px" lineHeight="1.9" color="#4A5568">
            ...
            our mobile application, or communicate with our personnel. This Data
            Protection Privacy Policy has been approved and provided by our
            Board and Legal Advisors.
          </Text>
          ...
          <Box>
            ...
            <Stack pl="16px" spacing="6px">
              ...
              <Text lineHeight="1.9">
                We regularly update our Privacy Policy, which we will notify you
                of on our mobile application or by email.
              </Text>
            </Stack>
          </Box>
          ...
          <Stack spacing="16px" lineHeight="1.9">
            <Text>
              ...
              contractual, strategic support, or partnership relationships with,
              our advisers, consultants, payment processors, identity
              verification providers, SMS and email service providers, cloud
              hosting providers, vendors, or sub-contractors.
            </Text>

            <Text>
              <strong>Client</strong> means a person (domestic or business) who
              uses the Errbud platform to book cleaning services.
            </Text>

            <Text>
              <strong>Cookies</strong> are small text files stored on your
              device to help us improve your experience and analyse how you use
              our services.
            </Text>
            ...
            <Text>
              ...
              determining the manner in which Personal Data would be processed.
            </Text>
            ...
            <Text>
              ...
              (UK GDPR and EU GDPR as applicable).
            </Text>

            <Text>
              <strong>ICO</strong> means the Information Commissioner's Office,
              the UK's independent authority for upholding information rights.
            </Text>
            ...
            <Text>
              <strong>Processing</strong> is any activity that involves the use
              of Personal Data. It includes obtaining, recording, or holding the
              data, or carrying out any operation or set of operations on the
              data, including organising, amending, recording, retrieving,
              using, disclosing, erasing, or destroying it. Processing also
              includes transferring Personal Data to third parties.
            </Text>

            <Text>
              <strong>Sensitive Personal Data</strong>includes information about
              ...
              condition, sexual life, biometric data (facial recognition for
              identity verification), or criminal convictions.
            </Text>
          </Stack>
          ...
          <Box mt="64px">
            <Stack spacing="48px">
              {/* Section Title */}
              <Heading fontSize={{ base: "22px", md: "28px" }} fontWeight={600}>
                PRIVACY POLICY
              </Heading>
              ...
              <Box>
                ...
                <Stack spacing="16px" pl="8px">
                  <Text>
                    ...
                    name, username or similar identifier, date of birth, gender,
                    photograph, government-issued identification documents
                    (passport, driver's license, national ID), facial
                    recognition data (for KYC verification), and National
                    Insurance Number (for Errbuddies).
                  </Text>

                  <Text>
                    <strong>Contact Data</strong> includes residential address,
                    property addresses (for cleaning service locations),
                    business facility addresses, email address and telephone
                    numbers.
                  </Text>

                  <Text>
                    <strong>Financial Data</strong> includes bank account
                    details (account number, sort code, bank name), payment card
                    information, transaction history, billing information, and
                  ...
                  <Text>
                    ...
                    (IP) address, domain name, your login data, browser type and
                    version, time zone setting and location, browser plug-in
                    types and versions, operating system and platform, device
                    type and unique device identifiers, and other technology on
                    the devices you use to access our mobile application or
                    website.
                  </Text>
                  ...
                  <Text>
                    ...
                    your preferences in receiving marketing communications from
                    us and our Affiliated Third Parties, your communication
                    preferences, and referral activity.
                  </Text>
                  ...
                  <Text>
                    ...
                    type, business operation hours, contract duration, cleaning
                    materials availability, contact person details, and business
                  ...
                  <Text>
                    ...
                    Tenancy), room selections, add-ons requested, date and time
                    of service, cleaner assignments, job status, and service
                    completion records.
                  </Text>

                  <Text>
                    <strong>Communication Data</strong> includes messages
                    exchanged between Clients and Errbuddies through our in-app
                    messaging system, support inquiries, complaint details, and
                    correspondence with our team.
                  </Text>

                  <Text>
                    <strong>Location Data</strong> includes your device location
                    (with your permission) to match you with nearby Errbuddies
              ...
              <Box>
                ...
                <UnorderedList spacing="8px" pl="24px">
                  <ListItem>
                    Create an account (domestic or business client, or Errbuddy)
                  </ListItem>
                ...
                <Text mt="16px">
                  ...
                  equipment, browsing actions and patterns. We collect this data
                  by using cookies and other similar technologies. Please see
                ...
                <UnorderedList spacing="8px" pl="24px" mt="8px">
                  ...
                  <ListItem>
                    Social media platforms (if you sign in with Google or Apple)
                  </ListItem>
                  <ListItem>
              ...
              <Box>
                ...
                <Text lineHeight="1.9">
                  Errbud is not intended for users under 18 years of age. We do
                  not knowingly collect Personal Data from minors. If you
                  believe we have collected data from a minor, please contact us
                  immediately at info@errbud.com.
                </Text>
              </Box>
            </Stack>
          </Box>
          ...
          <Box mt="64px">
            <Box maxW="1000px" mx="auto">
              ...
              {/* Intro Text */}
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="32px">
              ...
              <UnorderedList spacing="12px" pl="20px" mb="32px" color="#475467">
                <ListItem>
                ...
                <ListItem>
                  ...
                  you use our mobile application or visit our website.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  To prevent fraud, ensure platform safety, and protect against
              ...
              <UnorderedList spacing="12px" pl="20px" mb="32px" color="#475467">
                ...
                <ListItem>
                  To match you with available Errbuddies based on your location,
                  service requirements, and Errbuddy availability.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  For business clients: to manage contracts, service schedules,
                  and contract extension requests.
                </ListItem>
              </UnorderedList>
              ...
              <UnorderedList spacing="12px" pl="20px" mb="32px" color="#475467">
                <ListItem>
                  To assess and process your application to become an Errbuddy.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  To handle and investigate complaints submitted against you by
                  Clients.
                </ListItem>
                <ListItem>
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="32px">
                ...
                features, and promotional offers where your explicit consent has
                been given.
              </Text>
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                With your permission, we collect location data to match Clients
                with nearby Errbuddies, provide accurate service delivery, and
                improve our geographical coverage.
              </Text>

              <Text fontSize="15px" lineHeight="26px" color="#475467" mb="40px">
                Be aware that we do not reveal identifiable information about
                you to our advertisers, though we may at times share statistical
                visitor information with our advertisers.
              </Text>
              ...
              <UnorderedList spacing="12px" pl="20px" mb="48px" color="#475467">
                <ListItem>
                  <strong>Contract Performance:</strong> To provide the cleaning
                  services you've requested or to process your application to
                  become an Errbuddy.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  ...
                  services, ensure platform safety, prevent fraud, match Clients
                  with Errbuddies efficiently, and resolve disputes. We ensure
                  our legitimate interests do not override your fundamental
                  rights and freedoms.
                </ListItem>
                <ListItem>
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="16px">
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467">
                ...
                the new purpose is compatible with the original purpose, please
                contact us at info@errbud.com. If we need to use your Personal
                Data for an unrelated purpose, we will notify you and request
                your express consent before proceeding.
              </Text>
            </Box>
          </Box>
          ...
          <Box mt="64px">
            <Box maxW="1000px" mx="auto">
              ...
              <UnorderedList spacing="14px" pl="20px" mb="32px" color="#475467">
                <ListItem>
                  ...
                  cannot be implied, and we ensure that you have the opportunity
                  to read our data protection privacy policy before you provide
                  your consent. Consent in respect of Sensitive Personal Data
                  (such as facial recognition data, National Insurance Number)
                  must be explicit and will be given by you in writing to us or
                  through explicit opt-in mechanisms in our application.
                </ListItem>
                ...
                <ListItem>
                  The right to request that we delete your Personal Data that is
                  in our possession, subject to retention required for legal
                  purposes (tax, accounting, dispute resolution) and the time
                  required technically to delete such information. Please note
                  that deleting your account will prevent you from accessing the
                  Errbud platform.
                </ListItem>

                <ListItem>
                  The right to request access to your Personal Data or object to
                  our processing of the same. Where Personal Data is held
                  electronically in a structured form, you have a right to
                  receive that data in a common electronic format.
                </ListItem>

                <ListItem>
                  The right to rectify (update) your Personal Data that is kept
                  with us. You may update your username directly through your
                  profile settings. For changes to other personal information,
                  such as email, phone number, or name, please contact our
                  support team at info@errbud.com.
                </ListItem>

                <ListItem>
                  The right to receive your Personal Data and have it
                  transferred to another Data Controller (data portability), as
                  applicable.
                </ListItem>

                <ListItem>
                  The right to restrict processing of your Personal Data in
                  certain circumstances, such as while we verify the accuracy of
                  disputed data.
                </ListItem>
                ...
                <ListItem>
                  ...
                  (ICO) if you believe we have not handled your Personal Data
                  properly. You can contact the ICO at:
                  <Box mt="8px" pl="12px">
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="56px">
                You may exercise any of the above stated rights by following our
                Subject Access Request Response Procedure, detailed below or by
                contacting us at info@errbud.com.
              </Text>
              ...
              <UnorderedList spacing="12px" pl="20px" mb="24px" color="#475467">
                <ListItem>
                  Clients can see: Errbuddy's name, profile picture, Cleaner ID,
                  and cleaner category for Errbuddies assigned to their
                  bookings.
                </ListItem>
                <ListItem>
              ...
              <UnorderedList spacing="12px" pl="20px" mb="24px" color="#475467">
                ...
                <ListItem>
                  Analytics providers (to understand usage patterns and improve
                  our services - data is anonymised where possible).
                </ListItem>
                <ListItem>
                  Our Affiliated Third Parties who require your information for
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="56px">
                ...
                not allow our service providers to use your Personal Data for
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                ...
                authorised persons in charge of maintaining the servers. We have
                put in place physical, electronic and procedural processes that
                safeguard and protect your information against unauthorised
                access, modification or erasure.
              </Text>
              ...
              <UnorderedList spacing="12px" pl="20px" mb="32px" color="#475467">
                <ListItem>
                  Encryption of sensitive data in transit (using SSL/TLS) and at
                  rest.
                </ListItem>
                <ListItem>
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                ...
                programme is completely foolproof. In the unlikely event that we
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="32px">
                ...
                confidentiality by our staff is subject to disciplinary action.
              </Text>
          ...
          <Box mt="64px">
            <Box maxW="1000px" mx="auto">
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="20px">
                ...
                United Kingdom for the purposes stated above, particularly when
                we use third-party service providers (such as cloud hosting,
                payment processors, or identity verification providers) that
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                ...
                us, you acknowledge and consent to such transfer and processing.
                We will however take all reasonable steps to ensure that your
                data is treated securely and in accordance with this Privacy
                Policy. Transfer of your Personal Data will only be done:
              </Text>

              <UnorderedList spacing="14px" pl="20px" mb="24px" color="#475467">
                <ListItem>
                  To countries that provide an adequate level of data protection
                  as determined by the UK Government or relevant authorities.
                </ListItem>
                <ListItem>
                  Under Standard Contractual Clauses (SCCs) approved by the ICO
                  or other legally approved transfer mechanisms.
                </ListItem>
                <ListItem>
                  To parties who have put in place adequate controls, safeguards
                  and technical measures to secure and protect your Personal
                  Data in compliance with UK data protection standards.
                </ListItem>
              </UnorderedList>
              ...
              <UnorderedList spacing="12px" pl="20px" mb="24px" color="#475467">
                <ListItem>
                  Active account data: Retained while your account is active and
                  you continue to use our services.
                </ListItem>
                <ListItem>
                  Booking and transaction records: Retained for 6 years after
                  the transaction date for tax, accounting, and legal compliance
                  purposes.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  KYC and identity verification data: Retained for 7 years after
                  account closure for regulatory compliance and fraud
                  prevention.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  Communications and support inquiries: Retained for 3 years for
              ...
              <UnorderedList spacing="12px" pl="20px" mb="24px" color="#475467">
                <ListItem>
                  Most personal data is deleted within 90 days of your request.
                </ListItem>
                <ListItem>
                  Some data may be retained longer for legal, tax, fraud
                  prevention, or dispute resolution purposes as outlined above.
                </ListItem>
                <ListItem>
                  Anonymised or aggregated data may be retained indefinitely for
                  statistical analysis and service improvement (this data cannot
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                ...
                (such as social media platforms, payment providers, or support
                resources). Clicking on those links or enabling those
              ...
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                ...
                are not responsible for their privacy practices or content. When
                you leave our mobile application or website, we encourage you to
                read the privacy policy of every website or service you visit.
              </Text>
              <Text fontSize="16px" lineHeight="28px" color="#475467" mb="24px">
                The inclusion of any link does not imply endorsement by Errbud
                of the linked site or service. Use of any such linked website or
                service is at the user's own risk.
              </Text>
            </Box>
          </Box>
            ...
            <Stack spacing={10}>
              ...
              <Box>
                ...
                <Text color="gray.700" lineHeight="1.8">
                  ...
                  keeping you logged in, and analysing how you use our services.
                </Text>
                ...
                <Text mt={4} color="gray.700" lineHeight="1.8">
                  ...
                  The information is gained in a statistical manner for our use
                ...
                <Text mt={4} color="gray.700" lineHeight="1.8">
                  ...
                  our visitors and how they used our resources on the platform.
                  No identifying Personal Data will be shared at any time via
                  cookies with advertisers.
                </Text>
                ...
                <UnorderedList spacing={2} pl={6} color="gray.700">
                  <ListItem>
                    ...
                    platform to function properly (e.g., keeping you logged in,
                    remembering your session).
                  </ListItem>
                  <ListItem>
                    <strong>Performance Cookies:</strong> Help us understand how
                    you use our services and identify technical issues.
                  </ListItem>
                  <ListItem>
                ...
                <Text color="gray.700" lineHeight="1.8">
                  You may elect to decline all cookies via your device settings
                  or browser settings, or set up alerts to prompt you when
                  websites set or access cookies. Every computer and mobile
                  device can decline file downloads like cookies.
                </Text>
                ...
                <Text mt={2} color="gray.700">
                  ...
                  preferences through your device settings or within the Errbud
              ...
              <Box>
                ...
                <UnorderedList spacing={2} pl={6} mt={2} color="gray.700">
                  <ListItem>
                    Email: Send your request to info@errbud.com with the subject
                    line "Subject Access Request"
                  </ListItem>
                  <ListItem>
                    In-App: Submit a request through the Help & Support section
                    in your Errbud account
                  </ListItem>
            ...
            <Stack spacing={8}>
              ...
              <Box>
                ...
                <UnorderedList pl={6} spacing={2} color="gray.700">
                  ...
                  <ListItem>
                    Verify your identity using the details provided and a valid
                    means of identification (international passport, driver's
                    license, national identification card, or any other
                    acceptable means of identification)
                  </ListItem>
                  <ListItem>
                    Where the request is from a third party (such as a relative
                    or your representative), we will verify their authority to
                    act for you and may contact you directly to confirm their
                    identity and request your consent to disclose the
                    information
                  </ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box>
                ...
                <UnorderedList pl={6} spacing={2} color="gray.700">
                  ...
                  <ListItem>
                    Respond to your specific request in the format requested (in
                    writing, electronically via email, or through your Errbud
                    account)
                  </ListItem>
                  <ListItem>
                  ...
                  <ListItem>
                    ...
                    to your booking or another Client), we will seek the consent
                    of that person before processing the request
                  </ListItem>
                  <ListItem>
              ...
              <Box>
                ...
                <UnorderedList pl={6} spacing={3} color="gray.700">
                  ...
                  <ListItem>
                    ...
                    particularly complex or if you have made multiple requests.
                    In this case, we will notify you within one month and keep
                    you updated on our progress. We may extend the response
                    period by a further two months where necessary.
                  </ListItem>
                  <ListItem>
                    <strong>Inability to Act:</strong> Where we are unable to
                    act on your request, we shall inform you promptly, at least
                    within one month of receipt of the request, of the reasons
                    for not taking action and inform you of your right to
                    complain with the ICO.
                  </ListItem>
                  <ListItem>
                    <strong>Remedial Action:</strong> Where your request relates
                    to any perceived violation of your rights, we shall take
                    appropriate steps to remedy such violations once confirmed.
                    Remedies shall include, but not be limited to,
                    investigation, reporting to appropriate authorities,
                  ...
                  <ListItem>
                    <strong>Fees:</strong> Any information provided to you by us
                    shall be provided free of charge. However, where requests
                    are manifestly unfounded or excessive, in particular because
                    of their repetitive or cumbersome nature, we may:
              ...
              <Box>
                ...
                <Text color="gray.700" mb={3}>
                  ...
                  act on your request if at least one of the following applies:
                </Text>
                ...
                <OrderedList pl={6} spacing={2} color="gray.700">
                  ...
                  <ListItem>
                    ...
                    of others (such as revealing another user's Personal Data).
                  </ListItem>
                  <ListItem>
                  ...
                  <Text mt={4} color="gray.700">
                    Where we refuse a request, we will inform you of the reasons
                    and your right to complain to the ICO.
                  </Text>
                </OrderedList>
              </Box>
            </Stack>
          ...
          <Box mt="64px">
            <Stack spacing={8}>
              ...
              <Box>
                ...
                <UnorderedList pl={6} color="gray.700">
                  <ListItem>Email: info@errbud.com</ListItem>
                  <ListItem>Subject Access Requests: info@errbud.com</ListItem>
                </UnorderedList>
              </Box>
              ...
              <Box>
                <Text color="gray.700" mb={4}>
                  ...
                  understood, and agree to this Data Protection Privacy Policy.
                </Text>
